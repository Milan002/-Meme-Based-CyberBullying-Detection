...
# Usage
file_list = "./hateMemesList.txt.valid"  # Replace with your input file containing file names
folder_path = "./home/hate-speech-detection/data/train_data"  # Replace with your folder path
